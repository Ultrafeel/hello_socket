...
#$(OUT_TARG_DIR)/$(SERVER_NAME): $(OBJECTS)
...
clean:
	...
	-$(RM)  -rfv   $(OBJS) ./$(OUT_TARG_DIR)/$(SERVER_NAME) $(SERVER_NAME).o $(SERVER_NAME)  $(LIBS1) $(LIBS_FILENAMES) $(LIBS_OB) $(LIBSRCH:.h=.a) $(LIBSRCH:.h=.so)
